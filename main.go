...
func main() {
	/*
						...
						if os := runtime.GOOS; os == "linux" || os == "mac" {
							fmt.Println("El sistema OS es:", os)
						} else {
							fmt.Println("El sistema No es unix")
						}
						...
						case "windows":
							fmt.Println("El sistema darwin")
						default:
							fmt.Printf("%s \n", os)
						}


					numero, text := ejercicios.EjercicioUno("200")
					fmt.Println(numero)
					fmt.Println(text)
